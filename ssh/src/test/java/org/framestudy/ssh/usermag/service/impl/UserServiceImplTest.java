...
import org.framestudy.ssh.bean.HouseBean;
import org.framestudy.ssh.bean.PagerBean;
import org.framestudy.ssh.bean.UserBean;
import org.framestudy.ssh.bean.UserInfoBean;
...
//		
	...
	public void listUserBeanByUserNameAndLoginName() {
		...
		datas = userServiceImpl.listUserBeanByUserNameAndLoginName(userName, loginName);
		System.out.println(datas);
	}
