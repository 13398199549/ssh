package org.framestudy.ssh.usermag.dao.impl;
	...
	public PagerBean listUserBeanByParams2PagerBean(Map params, PagerBean pager) {
		...
		return (PagerBean) hibernateTemplate.execute(new HibernateCallback(){
			...
			public Object doInHibernate(Session session) throws HibernateException {
				// TODO Auto-generated method stub
				String hql = "select count(*) from UserBean as u where u.userName like CONCAT(:userName,'%')";
				...
				if (totalRows != 0) {
					// -----------------查询具体的数据------------------
					hql = "select new map(u.id as id,u.userName as userName) from UserBean as u where u.userName like CONCAT(:userName,'%')";
